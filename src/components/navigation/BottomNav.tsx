...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50">
      <nav className="glass rounded-2xl px-2 py-2 shadow-lg border border-border/40 flex items-center gap-1">
        {tabs.map((tab, i) => {
          ...
          return (
            ...
            >
              ...
              />
              <span className={`text-[9px] mt-0.5 relative z-10 transition-colors ${
